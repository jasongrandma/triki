...
3. Color customizable and savable site themes. Fully customize the CSS color palette by choosing different primary, secondary, tertiary and accent colors. Store custom themes to reuse later.